...
return [
    ...
    'attributes' => [
        ...
        'menu_funcion'          => 'función del menú',
        'menu_orden'            => 'orden del menú',
        'menu_icono'            => 'ícono del menú',
        'submenu_nombre'        => 'nombre del submenú',
        'submenu_funcion'       => 'función del submenú',
        'submenu_orden'         => 'orden del submenú',
    ],
];
